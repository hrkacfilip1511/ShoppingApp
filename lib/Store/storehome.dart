              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                      ...
                      ? IconButton(
                        icon: Icon(Icons.add_shopping_cart, color: Colors.orangeAccent,),
                        onPressed: () {
...
Widget card({Color primaryColor = Colors.redAccent, String imgPath}) {
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: <BoxShadow> [
        BoxShadow(offset: Offset(0, 5), blurRadius: 5.0, color: Colors.lightBlue),
      ],
    ),
    child: ClipRRect(
      borderRadius: BorderRadius.all(Radius.circular(25.0)),
...
addItemtoCart(String shortInfoAsID, BuildContext context){
 ...
 EcommerceApp.firestore.collection(EcommerceApp.collectionUser)
    ...
    .updateData({
      ...
      Fluttertoast.showToast(msg: "Artikl uspješno dodan.");
