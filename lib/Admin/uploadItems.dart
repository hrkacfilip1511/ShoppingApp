...
class _UploadPageState extends State<UploadPage>
              ...
              return !dataSnapshot.hasData
                  ...
                  : SliverStaggeredGrid.countBuilder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return adminInfo(model, context);
                      },
  ...
  capturePhotoWithCamera() async {
    //funkcija za pristup kameri na emulatoru
    Navigator.pop(context);
  ...
  pickPhotoFromGallery() async {
    //funkcija za pristup slika u galeriji na emulatoru
    Navigator.pop(context);
            ...
            title: Container(
              ...
              child: TextField(
                keyboardType: TextInputType
                    .number, //da na tipkovnici mozemo samo brojeve kucat
                style: TextStyle(color: Colors.deepOrangeAccent),
  ...
  saveItemInfo(String downloadUrl) {
    ...
    itemsReference.document(productID).setData({
      //spremanje podataka na Cloud Firestore
