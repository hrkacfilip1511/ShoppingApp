                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: Text("Početna", style: TextStyle(color: Colors.white)),
                        onTap: () {
                      ...
                      ListTile(
                        ...
                        title: Text("Moja košarica", style: TextStyle(color: Colors.white)),
                        onTap: () {
                      ...
                      ListTile(
                        ...
                        title: Text("Pretraži", style: TextStyle(color: Colors.white)),
                        onTap: () {
